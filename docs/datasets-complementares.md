...
| ONS — Fator de Capacidade Eólica e Solar | [dados.ons.org.br](https://dados.ons.org.br/dataset/fator-capacidade-2) | Geração programada e verificada, capacidade instalada, fator de capacidade, coordenadas | 2009 em diante | Horária | Usina / conjunto, com estado | Proxy de irradiação e vento | Média | Cobre usinas centralizadas; o RJ tem pouca geração eólica ou solar centralizada. Irradiação já vem das fontes climáticas | **Descartar** |
